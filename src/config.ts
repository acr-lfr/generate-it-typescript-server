...
import { HttpAppConfig } from '@/http/interfaces/HttpAppConfig';

dotenv.config();

export interface Config extends HttpAppConfig {
  // extend the config with your own app's config types here...
}
